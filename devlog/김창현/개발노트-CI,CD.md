...
* [1. 초기 배포 방식과 문제점](#1-초기-배포-방식과-문제점)
* [2. 무중단 배포 전략 검토](#2-무중단-배포-전략-검토)
* [3. 블루/그린 배포 적용](#3-블루그린-배포-적용)
* [4. AutoScaling 적용](#4-autoscaling-도입)
* [5. 최종 배포 전략: 롤링 배포로 전환](#5-최종-배포-전략-롤링-배포로-전환)
